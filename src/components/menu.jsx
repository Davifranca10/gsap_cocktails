...
const Menu = () => {
    ...
    useGSAP(() => {
        ...
        gsap.fromTo('#m-left-leaf', { yPercent: 100, opacity:0 }, { yPercent: 0,opacity:1, duration: 1.5, ease: 'power1.inOut' })
        gsap.fromTo('#m-right-leaf', { yPercent: -100, opacity:0}, { yPercent: 0,opacity:1, duration: 2, ease: 'power1.inOut' })
    ...
    return (
        <section id='menu' aria-labelledby='menu-heading'>
            ...
            <h2 id='menu-heading' className='sr-only'>Menu de Refris</h2>
            ...
            <div className='content'>
                ...
                <div className='recipe'>
                    ...
                    <div className='details'>
                        ...
                        <p id='description'>{currentCocktail.description}</p>
